<h1 class="page-header">
    <?php echo $pvd->IdPreso != null ? $pvd->Altura : 'Nuevo Registro'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=detpreso">DetallesPreso</a></li>
  <li class="active"><?php echo $pvd->IdPreso != null ? $pvd->Altura : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-detpreso" action="?c=detpreso&a=Editar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="IdPreso" value="<?php echo $pvd->IdPreso; ?>" />
